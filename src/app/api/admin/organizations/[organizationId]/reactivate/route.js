...
import { reactivateParkletOrganization } from '@/lib/server/parkletAdmin';
...
export async function POST(request, { params }) {
  ...
  try {
    const result = await reactivateParkletOrganization(request, organizationId, parsed.payload.reason);
