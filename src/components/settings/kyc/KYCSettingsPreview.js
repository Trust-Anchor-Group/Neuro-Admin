...
export default function KYCSettingsPreview({
    ...
    return (
		<div className="w-full  flex flex-col">
            <h2 className="text-[28px] font-semibold text-[var(--brand-text)] mb-6">{t?.kycPreview?.previewTitle || 'Preview (Beta)'}</h2>
			<div className="flex flex-col flex-shrink-0 bg-[var(--brand-background)] border border-[var(--brand-border)] rounded-xl p-5 lg:self-stretch">
                <p className="text-base text-[var(--brand-text-secondary)] mb-4">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-stretch">
                        ...
                        <div className="lg:w-1/2 max-h-[535px] flex flex-col rounded-l-xl bg-[var(--brand-navbar)] border-r border-[var(--brand-border)] shadow-sm overflow-hidden">
                            <div className="p-4 border-b border-[var(--brand-border)]">
                                ...
                                <div className="flex items-center justify-between text-base text-[var(--brand-text)] font-medium">
                                ...
                                {steps.map((step, idx) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center justify-between rounded-lg px-4 py-3 text-[var(--brand-text)] text-base font-semibold transition-colors ${
                                                isActive
                        ...
                        <div className="flex-1 flex flex-col h-[535px] rounded-r-xl border-l border-[var(--brand-border)] bg-[var(--brand-navbar)] p-5 shadow-sm">
                            <div>
                                ...
                                <h3 className="text-xl font-semibold text-[var(--brand-text)] mb-1">
