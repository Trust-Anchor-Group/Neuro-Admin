        ...
        max-sm:pb-5 max-sm:overflow-auto'>
            <div className='flex justify-between item-center max-sm:text-center mb-10 max-sm:flex-col'>
                ...
                user && user.data.state && (() => {
                        ...
                        if(action && action.actionTitle.includes('Created')){
                            return               <div className={`flex items-center gap-2 px-3 py-1 rounded-lg ${action.bgColor} ${action.textColor}
               ...
               user && user ? (
                    <div className=''>
                        <div className='grid grid-cols-2 gap-5 max-sm:grid-cols-1 max-sm:text-center max-sm:p-5'>
                            ...
                            <InputField labelText={'Identity Status'} name={user.data.state || 'N/A'}/>
                        </div>
                    </div> 
                ) : (
